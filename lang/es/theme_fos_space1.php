...
/* Landing page 
   - Slider component
*/
$string['slider1text'] = "<span class='slider_clour_text_white'>Bienvenido a <br/>Fòs Feminista</span> <br/><span class='slider_clour_text_orange'>comunidad <br/>de aprendizaje virtual</span>";
